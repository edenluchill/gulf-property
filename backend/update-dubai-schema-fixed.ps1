...
Write-Host ""
Write-Host "[2/4] Loading database credentials..." -ForegroundColor Yellow
...
Write-Host "  [OK] Database: $DB_NAME @ $DB_HOST" -ForegroundColor Green
...
Write-Host ""
Write-Host "[4/4] Applying schema updates..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "[OK] Verifying installation..." -ForegroundColor Yellow
