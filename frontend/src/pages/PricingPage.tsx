  ...
  const tiers = [
    {
      ...
      features: [
        L('交互式卫星地图 + 真实 DLD 数据', 'Interactive map + real DLD data'),
        L('区域指标 + 项目详情 + 投资分析', 'Area metrics + detail + analytics'),
        L('Luna 语音助手', 'Luna voice assistant'),
        L('经纪工具试用:带看/导览/报告 各 2 次', 'Agent trial: 2 each'),
      ],
    ...
    },
    {
      ...
      features: [
        L('实时带看 200 场/月', '200 live tours / mo'),
        L('Luna 导览 200 个/月', '200 Luna AI tours / mo'),
        L('意向报告 300 份/月', '300 reports / mo'),
        L('锁定创始价 · 优先支持 · 共建功能', 'Locked price · priority · shape features'),
      ],
