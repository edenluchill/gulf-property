  ...
  return (
    <div ref={setNodeRef} style={style} className="relative group">
      ...
      <div
        {...attributes}
        {...listeners}
        className="absolute start-0 top-1/2 -translate-y-1/2 -translate-x-full pe-2 cursor-grab active:cursor-grabbing opacity-0 group-hover:opacity-100 transition-opacity z-10"
      >
