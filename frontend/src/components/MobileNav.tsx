...
export default function MobileNav() {
  ...
  // 6 档是 admin/uploader 才会碰到的(多一个「管理」)。普通用户 5 档。
  const gridCols = ({ 3: 'grid-cols-3', 4: 'grid-cols-4', 5: 'grid-cols-5', 6: 'grid-cols-6' } as Record<number, string>)[navItems.length] || 'grid-cols-4'
