  ...
  return (
    <>
      ...
      <div className="fixed z-[10001] flex flex-col bg-white shadow-2xl
                      ...
                      md:w-[760px] md:max-h-[85vh] md:rounded-2xl overflow-hidden">
        {/* Mobile drag handle */}
                      ...
                      {dev.projectNames.length > 0 && (
                        <div className="flex flex-wrap gap-1.5 mt-2">
                          {dev.projectNames.map((name, i) => (
                            <span key={i} className="inline-block px-2 py-0.5 bg-slate-50 text-slate-600 rounded text-[11px] border border-slate-100 truncate max-w-[180px]">
                              {name}
                            </span>
                          ))}
